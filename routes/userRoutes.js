...
const { createArtist, loginArtist, getArtist, updateProfile, getAllArtist, getBand, getDjs } = require("../controllers/artistController");
...
Router.get('/getMusicArtist', getDjs )
